...
public class MatchingServiceTests {
    ...
    /**
     * Scores a single candidate profile against a single job. Pulled out of
     * findMatches() so the matching logic can be unit tested directly with
     * plain CandidateProfile/Job objects, without needing a live database.
     */
